<?php
//Module config
$districtConfig['MaxSizeX'] = 7;
$districtConfig['MaxSizeY'] = 5;
$districtConfig['BarracksMaxWarriors'] = 10000;
$districtConfig['BarracksMaxArchers'] = 5000;
$districtConfig['GeneralBuff'] = 0.1821715;
$districtConfig['GeneralTroops'] = 2500;
$districtConfig['GeneralCost'] = 2500000;
$districtConfig['GeneralCostDaily'] = 300000;
$districtConfig['WarriorCost'] = 45000;
$districtConfig['WarriorCostDaily'] = 5500;
...
$districtConfig['ArcherCost'] = 80000;
$districtConfig['ArcherCostDaily'] = 11000;
...
function returnTileIcon($district)
{
    global $db;
    $q=$db->query("SELECT * FROM `guild_districts` WHERE `district_id` = {$district}");
    $r=$db->fetch_row($q);
    if ($r['district_type'] != 'normal')
        return loadImageAsset("districts/tile-{$r['district_type']}.svg", 1.1);
}